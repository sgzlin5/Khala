...
/* Punch Prepare */
#define MSG_TYPE_PUNCH_HELLO                13
#define MSG_TYPE_PUNCH_METHOD               14
#define MSG_TYPE_CHANGE_METHOD              15
#define MSG_TYPE_PUNCH_DONE                 16
/* N4 */
#define MSG_TYPE_N4_HELLO                   17
#define MSG_TYPE_N4_PIINFO                  18
/* Juice */
#define MSG_TYPE_JUICE_SDP                  19
#define MSG_TYPE_JUICE_CANDIDATE            20
/* P2P */
#define MSG_TYPE_P2P_PING                   21
#define MSG_TYPE_P2P_PONG                   22
#define MSG_TYPE_MAX_TYPE                   MSG_TYPE_P2P_PONG

#define DEFAULT_TURN_USER                   "khala"
#define DEFAULT_TURN_PASWD                  "khala"
...
#define REGISTRATION_TIMEOUT             360
...
#define HASH_ADD_PAIRS(head,add) \
    HASH_ADD(hh,head,pair_id,sizeof(n2n_pairs_id_t),add)
#define HASH_FIND_PAIRS(head,id,out) \
    HASH_FIND(hh,head,id,sizeof(n2n_pairs_id_t),out)

#define HASH_ADD_PUNCH(head,add) \
    HASH_ADD(hh,head,name,sizeof(n2n_desc_t),add)
#define HASH_FIND_PUNCH(head,id,out) \
    HASH_FIND(hh,head,id,sizeof(n2n_desc_t),out)
...
#define N2N_MSG_BUF_SIZE           (N2N_PKT_BUF_SIZE / 2)
